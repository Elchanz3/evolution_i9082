...
struct kona_freq_tbl kona_freq_tbl[] = {
	...
	FTBL_INIT(1750000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1800000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1960000, PI_PROC_OPP_TURBO),
	FTBL_INIT(2040000, PI_PROC_OPP_TURBO),
#else
	FTBL_INIT(312000, PI_PROC_OPP_ECONOMY1),
	...
	FTBL_INIT(1200000, PI_PROC_OPP_TURBO),
        FTBL_INIT(1350000, PI_PROC_OPP_TURBO),
        FTBL_INIT(1400000, PI_PROC_OPP_TURBO),
#endif
#endif
};
